...
csv_files = ["output_22.csv", "output_23.csv", "output_25.csv", "output_27.csv", "output_28.csv", "output_29.csv"]  # Add your file names here
...
blended_df.to_csv("predict.csv", index=False, encoding='utf-8')
